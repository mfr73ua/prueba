...
class Interfaz:
    ...
    def pantalla_login(self):
        ...
        tk.Label(self.root, text="🔐 Iniciar Sesión", font=("Arial", 18, "bold")).pack(pady=20)
        ...
        tk.Button(self.root, text="🚪 Entrar", width=20, command=self.verificar_login).pack(pady=10)
    ...
    def pantalla_principal(self):
        ...
        botones = [
            ...
            ("🔎 Explorar rutas disponibles", self.explorar_rutas),
